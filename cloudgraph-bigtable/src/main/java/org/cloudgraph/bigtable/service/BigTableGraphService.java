...
public class BigTableGraphService implements PlasmaDataAccessService, GraphService {

  private static Log log = LogFactory.getLog(BigTableGraphService.class);
  protected ServiceContext context;

  public BigTableGraphService() {
  }
