...
import org.cloudgraph.core.graph.CellConverter;
...
public class GraphEdgeReader extends DefaultEdgeOperation implements EdgeReader {
  ...
  GraphEdgeReader(PlasmaType sourceType, PlasmaProperty sourceProp, Long typeSequenceNum,
    ...
    super(sourceType, sourceProp, tableConfig, graphConfig, rowReader, serviceContext);
  ...
  GraphEdgeReader(PlasmaType targetType, PlasmaProperty sourceProp, TableMapping tableConfig,
      DataGraphMapping graphConfig, RowReader rowReader, ServiceContext serviceContext)
      throws IOException {
    super(targetType, sourceProp, tableConfig, graphConfig, rowReader, serviceContext);
