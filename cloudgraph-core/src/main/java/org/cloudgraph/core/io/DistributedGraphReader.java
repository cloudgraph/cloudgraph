 ...
 * </p>
 * 
 * @see org.cloudgraph.core.io.GraphTableReader
...
public class DistributedGraphReader implements DistributedReader {
  ...
  public DistributedGraphReader(Type rootType, List<Type> types, Connection connection,
    ...
    TableMapping rootTable = StoreMapping.getInstance().findTable(root.getQualifiedName(),
        this.serviceContext.getStoreMapping());
    this.connection = connection;

    TableReader tableReader = new GraphTableReader(rootTable, this, this.serviceContext);
    ...
    for (Type t : types) {
      ...
      if (tableReader == null) {
        ...
        tableReader = new GraphTableReader(table, this, this.serviceContext);
        this.tableReaderMap
