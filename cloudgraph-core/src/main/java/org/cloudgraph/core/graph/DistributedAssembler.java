 ...
 * must be determined.
 * 
 * @see org.cloudgraph.core.io.DistributedReader
 * @see org.cloudgraph.core.io.TableReader
 * @see org.cloudgraph.core.io.RowReader
 * @author Scott Cinnamond
 * @since 0.5.1
 */
public abstract class DistributedAssembler extends DefaultAssembler implements CoreGraphAssembler {
  ...
  public void assemble(CellValues resultRow) {
    ...
    for (TableReader tableReader : this.distributedReader.getTableReaders()) {
      tables.add(tableReader.getNamespaceQualifiedPhysicalTableName()); // FIXME:
      // should
      // be relative
      // name
    }
