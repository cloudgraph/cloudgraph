 ...
 * 	DefaultOptions options = new DefaultOptions(graph.getRootObject().getType()
 * 			.getURI());
 * 	options.setRootNamespacePrefix(&quot;c&quot;);
 * 	options.setPrettyPrint(false);
 * 	XMLDocument doc = PlasmaXMLHelper.INSTANCE.createDocument(
 * 			graph.getRootObject(), graph.getRootObject().getType().getURI(),
 * 			null);
 ...
 * @since 0.5.8
 */
public class GraphXmlRecordReader
		extends
