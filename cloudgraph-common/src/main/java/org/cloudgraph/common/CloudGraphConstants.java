...
public class CloudGraphConstants {
	 ...
	 * on the root and other nodes across a distributed graph.
	 */
	public static final String ROW_KEY = CoreConstants.PROPERTY_NAME_ROWKEY;
	
    /**
	 * An SDO instance property used to store the sequence
	 * associated with each data object. The sequences are
	 * available on graph assembly, and needed for fast
	 * construction of column qualifiers during update
