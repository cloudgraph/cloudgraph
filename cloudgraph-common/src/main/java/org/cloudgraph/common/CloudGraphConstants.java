...
public class CloudGraphConstants {
	...
	/**
	 * An SDO instance property representing the total time in milliseconds
	 * taken for round trips to the underlying data store(s) while assembling a
	 * data graph.
	 */
	...
	/**
	 * An SDO instance property used to set / cache row keys on the root and
	 * other nodes across a distributed graph.
	 */
	 ...
	 * data object. The sequences are available on graph assembly, and needed
	 * for fast construction of column qualifiers during update and delete
	 * operations.
	 */
