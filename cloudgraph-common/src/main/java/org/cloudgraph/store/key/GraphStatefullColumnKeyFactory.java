...
public interface GraphStatefullColumnKeyFactory extends GraphColumnKeyFactory {
	...
	/**
	 * Generates and returns a column key based on the given arguments
	 * as well as the configured CloudGraph column key {@link org.cloudgraph.config.ColumnKeyModel
     * model} for a specific table {@link org.cloudgraph.config.Table configuration}.  
	 * @param dataObject the data object
	 * @param sequenceNum the graph row specific sequence number for the 
	 * type associated with the given data object
	 ...
	 */
	public byte[] createColumnKey( 
			PlasmaDataObject dataObject, long sequenceNum, PlasmaProperty property, EdgeMetaField metaField);
	...
	public byte[] createColumnKey(PlasmaType type, long sequenceNum, EntityMetaField metaField);
	public byte[] createColumnKey(PlasmaType type, long sequenceNum, EdgeMetaField metaField);
	 ...
	 * @param sequenceNum the graph row specific sequence number for the given type
	 * for a data object
	 * @param property the property
	 * @return the column key bytes
	 */
