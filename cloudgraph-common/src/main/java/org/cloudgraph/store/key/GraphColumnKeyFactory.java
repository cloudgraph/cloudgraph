...
public interface GraphColumnKeyFactory {
	...
	/**
	 * Generates and returns a column key based on the given metadata type and meta field
	 ...
	 */
	public byte[] createColumnKey(PlasmaType type, EntityMetaField metaField);
	 ...
	 * @return the column key bytes
	 */
	public byte[] createColumnKey(PlasmaType type, EdgeMetaField metaField);
	 ...
	 */
	public byte[] createColumnKey( 
	    PlasmaType type, PlasmaProperty property, EntityMetaField metaField);
	 ...
	 */
	public byte[] createColumnKey( 
	    PlasmaType type, PlasmaProperty property, EdgeMetaField metaField);
}
