...
/**
 * Exception that indicates a row was not found but expected
...
public class MissingRowException extends GraphServiceException
{
    ...
    /**
     * Constructor. 
     * @param table the name of the table for the expected row
     * @param rowKey the row key
     */
    public MissingRowException(String table, String rowKey)
    {
        super("expected row for key '" + rowKey + "' for table '"
    		+ table + "' - note: if the composite row key includes a UUID "
