...
public class SocialGraphWideRowTest extends SocialGraphModelTest {
	...
	public void testUpdateDataProperties() throws IOException {
		...
		for (Photo photo : fetchedActor.getPhoto()) {
			...
			photo.setDescription(photo.getDescription()
					+ " - updated photo description " + String.valueOf(i));
			i++;
		}
		...
		log.debug(xml);
		Blog updatedBlog = (Blog) fetchedActor
				.get("blog[name='Hurricane Sandy']");
	...
	public void testUpdateAddChildTopic() throws IOException {
		...
		Topic topic = (Topic) fetchedActor
				.get("blog[name='Hurricane Sandy']/topic[name='Politics']");
	...
	public void testUpdateAddChildTopicHierarchy() throws IOException {
		...
		grandChild1
				.setDescription("The new Jersey Governor and his 'Bridge Gate' scandal");
