 ...
 * @since 1.0.7
 */
public class SocialGraphParallelDistributedTest extends SocialGraphModelTest {
  private static Log log = LogFactory.getLog(SocialGraphParallelDistributedTest.class);

  public static Test suite() {
    return PlasmaTestSetup.newTestSetup(SocialGraphParallelDistributedTest.class);
  }
