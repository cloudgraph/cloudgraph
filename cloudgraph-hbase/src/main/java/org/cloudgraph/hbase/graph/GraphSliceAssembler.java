			...
			int level) throws IOException 
	{
		for (long sequence : sequences) {	
        	...
        	{            		
        		...
        		PlasmaDataObject existingChild = (PlasmaDataObject)childRowReader.getDataObject(sequence, subType);
...
//            childRowReader.addDataObject(child);
	...
	private void assembleExternalEdges(PlasmaDataObject target, long targetSequence, PlasmaProperty prop, 
...
//	    	}
			...
			this.assembleExternalEdge(childRowKey, collection, childTableReader, 
					target, targetSequence, prop, level);
	    	i++;
		}
	}
