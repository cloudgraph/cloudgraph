...
class GraphSliceSupport {
	...
	public Map<String, Result> filter(  
			PlasmaType contextType, EdgeOperation collection, 
	 ...
	 */
	public Set<Long> fetchSequences(PlasmaType contextType,
        ...
        //if (!multiDescendantProperties) {
        	filterAssembler =  new ColumnPredicateFilterAssembler(  
        			rootType);
        //}
        //else {
...
//	public Set<Integer> fetchSequences(PlasmaType contextType, long contextSequence,
...
//        byte[] key = rowReader.getColumnKeyFactory().createColumnKey(contextType, contextSequence, property, KeyMetaField._SEQ_);
