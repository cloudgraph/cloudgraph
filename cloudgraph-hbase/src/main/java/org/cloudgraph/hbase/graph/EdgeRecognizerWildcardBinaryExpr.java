 ...
 */
public class EdgeRecognizerWildcardBinaryExpr extends DefaultWildcardBinaryExpr
		implements
			WildcardBinaryExpr {
	private static Log log = LogFactory
			.getLog(EdgeRecognizerWildcardBinaryExpr.class);
	 ...
	 * @see EdgeRecognizerContext
	 */
	public EdgeRecognizerWildcardBinaryExpr(Property property,
			String columnQualifierPrefix, Literal literal,
