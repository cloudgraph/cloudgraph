...
public interface EdgeWriter extends EdgeOperation {
	...
	public abstract void replace(PlasmaDataObject oldValue,
			PlasmaDataObject newValue) throws IOException;
	...
	public abstract void addAll(PlasmaNode dataNode, List<PlasmaEdge> edges)
			throws IOException;

	/**
	 * Determines which object the user intentionally removed and/or added based
	 * on the change summary of the client graph. Then removes and/or adds to
	 * the existing collection, just what the user has indicated.
	 * <p>
	 * </p>
	 ...
	 * @throws IOException
	 */
	public abstract void merge(PlasmaNode dataNode,
			HashSet<PlasmaDataObject> oldValues, List<PlasmaEdge> currentEdges)
			throws IOException;
