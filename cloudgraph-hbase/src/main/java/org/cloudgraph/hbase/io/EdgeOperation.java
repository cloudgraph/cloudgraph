...
public interface EdgeOperation {
	...
	/**
	 * Returns the sequence identifiers for entities of the collection. Only
	 * used for local (non external) collections.
	 * 
	...
	/**
	 * Returns the row keys for entities of the collection. Only used for
	 * external (non local) collections.
	 * 
