...
public interface RowReader extends RowOperation {
	...
	public EdgeReader getEdgeReader(PlasmaType type, PlasmaProperty property, long sequence) throws IOException;
	public boolean edgeExists(PlasmaType type, PlasmaProperty property, long sequence) throws IOException;
