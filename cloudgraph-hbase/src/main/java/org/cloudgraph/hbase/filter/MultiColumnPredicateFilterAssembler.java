 ...
 * @since 0.6.5
 */
public class MultiColumnPredicateFilterAssembler
		extends
			MultiColumnPredicateVisitor implements PredicateFilterAssembler {
	private static Log log = LogFactory
			.getLog(MultiColumnPredicateFilterAssembler.class);
	 ...
	 */
	public MultiColumnPredicateFilterAssembler(PlasmaType rootType) {
		super(rootType);
