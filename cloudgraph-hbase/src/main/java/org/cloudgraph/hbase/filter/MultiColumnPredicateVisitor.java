...
public class MultiColumnPredicateVisitor extends PredicateVisitor {
  ...
  protected FilterList qualifierFilterList = new FilterList(FilterList.Operator.MUST_PASS_ONE);
  protected FilterList valueFilterList = new FilterList(FilterList.Operator.MUST_PASS_ALL);
