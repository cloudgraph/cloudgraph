...
/**
 * Creates an HBase value and qualifier filter hierarchy using <a target="#" href="http://hbase.apache.org/apidocs/org/apache/hadoop/hbase/filter/QualifierFilter.html">QualifierFilter</a> 
    ...
    {		
        ...
        if (childExprCount > 0) {
        	...
        	if (!predicateUtil.hasHeterogeneousDescendantProperties(expression)) {
        		...
        		// Remember we are querying for QUALIFIERS, so multiple (heterogeneous) 
