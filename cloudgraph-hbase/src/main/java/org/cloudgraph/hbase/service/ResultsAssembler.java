...
public interface ResultsAssembler {
    ...
    /**
     * Determines whether the given row is to be added to the underlying collection returning
     * true if the given row is added and false if the given row is not added.
     * @param resultRow the row
     * @return true if the given row is added and false if the given row is not added.
     * @throws IOException
     */
