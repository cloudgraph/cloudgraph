...
public class Create extends DefaultMutation implements Collector {
        	...
        	RowWriter rowWriter) throws IOException, IllegalAccessException  
    {
        ...
        this.updateOrigination(dataObject, sequence, type, rowWriter); //FIXME refactor
        this.updateOptimistic(dataObject, sequence, type, rowWriter); //FIXME refactor
        ...
        for (Property p : properties)  
        {
        	...
        	if (!property.getType().isDataType()) {
        		...
        		List<PlasmaEdge> ownedEdges = this.findOwnedEdges(dataNode, property, 
