...
import org.cloudgraph.aerospike.test.DataTypeGraphModelTest;
...
public class IntPartialRowKeyScanTest extends DataTypeGraphModelTest {
  ...
  protected Node fetchSingleGraph(int rootId, int id, String name, Object date) {
    QIntNode root = createSelect(name);
  ...
  private QIntNode createSelect(String name) {
