 ...
 * @see org.cloudgraph.aerospike.service.AerospikeDataConverter
 * @author Scott Cinnamond
 * @since 0.5
 */
public class RealLiteral extends ScanLiteral implements PartialRowKeyLiteral, CompleteRowKeyLiteral {
