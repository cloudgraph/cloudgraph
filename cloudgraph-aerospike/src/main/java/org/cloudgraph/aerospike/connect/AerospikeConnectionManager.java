...
public class AerospikeConnectionManager {
  ...
  private static final Log log = LogFactory.getLog(AerospikeConnectionManager.class);

  private static volatile AerospikeConnectionManager instance;
  ...
  public static AerospikeConnectionManager instance() {
    if (instance == null)
      initInstance();
    return instance;
  }
  ...
  private static synchronized void initInstance() {
    if (instance == null)
      instance = new AerospikeConnectionManager();
  }
  ...
  public void createTable(Connection connection, TableName name, StoreMappingContext mappingContext) {
    throw new GraphServiceException("not implemented");
