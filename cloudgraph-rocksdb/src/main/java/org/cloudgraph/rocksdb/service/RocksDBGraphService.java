...
public class RocksDBGraphService implements PlasmaDataAccessService {

  private static Log log = LogFactory.getLog(RocksDBGraphService.class);
  protected ServiceContext context;

  public RocksDBGraphService() {
  }
