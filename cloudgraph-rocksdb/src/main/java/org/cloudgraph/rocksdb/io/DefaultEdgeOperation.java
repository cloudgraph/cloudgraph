...
import org.cloudgraph.rocksdb.ext.Cell;
...
public abstract class DefaultEdgeOperation implements EdgeOperation {
  ...
  protected DataType baseTypeQualDataType;
  protected DataType subTypeQualDataType;
  protected DataType pathQualDataType;
  protected DataType sequencesQualDataType;
  // protected byte[] tableQual;
  protected DataType keysQualDataType;
  protected DataType countQualDataType;

  protected String typeQualStr;
  protected String subTypeQualStr;
