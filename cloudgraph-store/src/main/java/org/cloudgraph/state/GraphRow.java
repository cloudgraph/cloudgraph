...
public class GraphRow implements RowState {
	...
	public GraphRow(byte[] rowKey, DataObject rootDataObject) {
		...
		this.graphConfig = CloudGraphConfig.getInstance().getDataGraph(
				rootTypeQname);		
	}
	...
	public void addDataObject(DataObject dataObject) {
		 ...
		 if (this.dataObjectMap.get(hashCode) != null) {
			 throw new IllegalArgumentException("data object already added, "
				+ dataObject ); 
		 }
	...
	public DataObject getDataObject(Long sequence, PlasmaType type) {
		...
		if (result == null) 
			 throw new IllegalArgumentException("data object ("
				+ sequence + ") not found for sequence/type, " + String.valueOf(sequence) + "/" + type); 
	    return result;
	}
	...
	public void addDataObject(DataObject dataObject, Long sequence,
		...
		if (result != null) 
			 throw new IllegalArgumentException("data object ("
				+ sequence + ") already exists for sequence/type, " + String.valueOf(sequence) + "/" + type); 
		this.dataObjectMap.put(hashCode, dataObject);	
	}
	@Override
	...
	protected int getHashCode(PlasmaType type, 
