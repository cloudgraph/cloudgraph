...
public class CloudGraphConfigDataBinding implements DataBinding {
    ...
    public CloudGraphConfigDataBinding(BindingValidationEventHandler validationEventHandler)
        ...
        if (stream == null)
            throw new CloudGraphConfigurationException("could not find configuration file schema resource '" 
