...
public interface Config {
	...
	/**
	 * Returns a table configuration for the given qualified SDO Type name or
	 * null if not found.
	 * 
	 * @param typeName
	...
	/**
	 * Returns a table configuration for the given SDO Type or null if not
	 * found.
	 * 
	 * @param type
	 *            the SDO Type
	 ...
	 * @throws CloudGraphConfigurationException
	 *             if no configured data graph exists for the given qualified
	 *             SDO Type name
	 */
