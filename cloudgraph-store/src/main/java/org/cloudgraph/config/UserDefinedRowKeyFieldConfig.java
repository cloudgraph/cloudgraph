...
public class UserDefinedRowKeyFieldConfig extends KeyFieldConfig {
  ...
  public UserDefinedRowKeyFieldConfig(DataGraphConfig dataGraph, UserDefinedField userDefinedField,
    ...
    for (int i = 0; i < tokens.length; i++) {
      ...
      if (!prop.getType().isDataType()) {
        ...
        if (i == tokens.length - 1)
          throw new CloudGraphConfigurationException("expected xpath '" + xpath
