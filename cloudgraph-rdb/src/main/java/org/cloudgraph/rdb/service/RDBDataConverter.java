...
public class RDBDataConverter {
	...
	public DataFlavor toJDBCDataFlavor(PlasmaProperty sourceProperty) {
		if (!sourceProperty.getType().isDataType())
			throw new IllegalArgumentException(
					"expected data type property, not "
	...
	private Object convertToSqlValue(Property property, Object value)
		...
		if (!property.getType().isDataType())
			throw new IllegalArgumentException(
					"expected data type property, not " + property.toString());
		...
		switch (dataType) {
			...
			case YearMonthDay :
			case Duration :
				result = DataConverter.INSTANCE.toString(property.getType(),
						value);
				break;
			case Date :
				...
				Date date = DataConverter.INSTANCE.toDate(property.getType(),
						value);
			...
			case DateTime :
				...
				break;
			case Decimal :
				result = DataConverter.INSTANCE.toDecimal(property.getType(),
						value);
				break;
			case Bytes :
				result = DataConverter.INSTANCE.toBytes(property.getType(),
						value);
				break;
			case Byte :
				result = DataConverter.INSTANCE.toByte(property.getType(),
						value);
				break;
			case Boolean :
				result = DataConverter.INSTANCE.toBoolean(property.getType(),
						value);
				break;
			case Character :
				result = DataConverter.INSTANCE.toString(property.getType(),
				...
				break;
			case Double :
				result = DataConverter.INSTANCE.toDouble(property.getType(),
						value);
				break;
			case Float :
				result = DataConverter.INSTANCE.toDouble(property.getType(),
				...
				break;
			case Int :
				result = DataConverter.INSTANCE
						.toInt(property.getType(), value);
				break;
			case Integer :
				result = DataConverter.INSTANCE.toInteger(property.getType(),
						value);
				break;
			case Long :
				result = DataConverter.INSTANCE.toLong(property.getType(),
						value);
				break;
			case Short :
				result = DataConverter.INSTANCE.toShort(property.getType(),
						value);
				break;
			case Strings :
				result = DataConverter.INSTANCE.toString(property.getType(),
	...
	private Object convertFrom(ResultSet rs, int columnIndex, int sourceType,
		...
		DataType targetDataType = DataType
				.valueOf(property.getType().getName());
		switch (targetDataType) {
			...
			case DateTime :
				...
				if (ts != null) {
					...
					result = DataConverter.INSTANCE.getDateTimeFormat().format(
							date);
				}
				break;
			case Decimal :
